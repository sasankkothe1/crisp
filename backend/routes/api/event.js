...
router.post('/', middleware.protect, upload.array('media'), EventController.create);
router.get('/', EventController.listEvents);
router.get('/new', EventController.listNewEvents);
router.get('/postedBy/:id', middleware.protect, EventController.listEventsByUserID);
router.get('/soonEnding', EventController.listSoonEndingEvents);
router.get('/:id', middleware.protect, EventController.read);
router.put('/:id', middleware.protect, upload.array('media'), EventController.update);
